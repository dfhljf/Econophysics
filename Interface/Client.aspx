...
<body>
    ...
    <table style="width:100%;height:100%;">
        <tr>
            <td class="title" colspan="7"><strong><label id="expinfo" runat="server"></label></strong></td>
        </tr>
        ...
        <tr class="buy">
            <td  colspan="2"><asp:Button ID="sell" runat="server" Text="卖" OnClick="sell_Click" AccessKey="-" Height="80%" style="font-size: x-large; font-weight: 700;font-family:'Microsoft YaHei'; background-color: #6699FF" Width="164px" /></td>
            <td  colspan="2"><asp:Button ID="buy" runat="server" Text="买" OnClick="buy_Click" AccessKey="+" Height="80%" style="font-size: x-large; font-weight: 700; font-family:'Microsoft YaHei'; background-color: #FF5050" Width="164px" /></td>
        </tr>  
    </table>
    </div>
    </form>
